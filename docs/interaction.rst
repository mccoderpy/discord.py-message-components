...
.. class:: Interaction
   ...
   .. note::
      For general information's about Interactions visit the `Discord-APIMethodes-Documentation <https://discord.com/developers/docs/interactions/slash-sub_commands#interaction-object>`_ of the discord-api.
