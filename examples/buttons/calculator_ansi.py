...
def escape_ansi(line) -> str:
    """To remove the ansi characters when creating a calculator instance from an existing message"""
...
class CalculatorUnit:
    ...
    async def update_display(self, interaction: discord.BaseInteraction = None):
        ...
        output = f'\u001b[1;34m{output}\u001b[0m'.replace("-", f"\u001b[33m-\u001b[34m")
        method = f"\u001b[0;31m{self.method}\u001b[0m".replace('**', '^')
...
class Calculator(commands.Cog):
    ...
    def get_calculator(self, message: discord.Message, author) -> typing.Optional[CalculatorUnit]:
        try:
            ...
            description = escape_ansi(message.embeds[0].description).split('|')
